      ...
      <div className="flex-1 overflow-y-auto px-6 pt-4">
        ...
        <div className="mt-6 rounded-[20px] border border-mist bg-mist-soft p-4">
          ...
          <p className="mt-2 text-[13px] leading-relaxed text-ink-soft">
            Hola {nombre || "Lucía"}, Rodrigo te invita al círculo de medy para acompañar a Silvia. Descargá la app acá: <span className="text-sage-dark underline">medy.app/i/A3F9</span>
          </p>
        </div>
      </div>
